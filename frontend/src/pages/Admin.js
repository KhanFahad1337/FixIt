                ...
                <div className="chart-card">
                  <ResponsiveContainer width="100%" height={320}>
                    <ComposedChart data={chartData}>
                      ...
                      <YAxis yAxisId="right" orientation="right" tick={{ fontSize: 11, fill: '#008080' }} />
                      <Tooltip
                      ...
                      <Area yAxisId="left" type="monotone" dataKey="bookings" fill="#008080" fillOpacity={0.15} stroke="#008080" strokeWidth={2} name="Bookings" />
