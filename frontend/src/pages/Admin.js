                ...
                <div className="chart-card">
                  <ResponsiveContainer width="100%" height={320}>
                    <ComposedChart data={chartData}>
                      ...
                      <YAxis yAxisId="right" orientation="right" tick={{ fontSize: 11, fill: '#117a2b' }} />
                      <Tooltip
                        contentStyle={{ background: dark ? '#1a1a1a' : '#fff', border: `1px solid ${dark ? '#2a2a2a' : '#e0e0e0'}`, borderRadius: 8, color: dark ? '#e8e8e8' : '#333' }}
                        labelFormatter={d => `Date: ${d}`}
                      />
                      <Legend wrapperStyle={{ fontSize: 12, color: dark ? '#e8e8e8' : '#333' }} />
                      <Area yAxisId="left" type="monotone" dataKey="bookings" fill="#117a2b" fillOpacity={0.15} stroke="#117a2b" strokeWidth={2} name="Bookings" />
